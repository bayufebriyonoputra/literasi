...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h2>Laporan Ketercapaian Pembiasaan Ekstensif</h2>
        ...
        <form action="/ketercapaian-ekstensif-filter" method="POST">
            @csrf
            <div class="row mb-4">
                ...
                <table class="table">
                    ...
                    <tbody class="table-border-bottom-0">
                        ...
                        <tr>
                            ...
                            <td>{{$jumlah_siswa != 0 ? round(($memenuhi / $jumlah_siswa) * 100, 2) : '0' }}%</td>
                        </tr>
                    </tbody>
                </table>
            </div>
