...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Modul &nbsp;</span>Laporan Kegiatan Perpustakaan</h4>
        <p>Pilih Kelas</p>
        <form method="POST" action="/filter-kegiatan" class="mb-4">
            @csrf
            <div class="row">
                <div class="col-md-10">
                ...
                <tbody>
                    @foreach ($kegiatan as $k)
                        <tr>
                            ...
                            <td>{{ $k->count() }} </td>
                            <td><a href="/inovasi-detail-kegiatan/{{ $k[0]->siswa_id }}" class="btn btn-info">Detail</a>
                            </td>
