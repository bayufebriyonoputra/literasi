...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Modul &nbsp;</span>Review</h4>
                ...
                <tbody>
                    @foreach ($review as $r)
                        <tr>
                            ...
                            <td>{{ $r->review }}</td>
                            <td>
                                <a href="/review-literasi/{{ $r->id }}/edit" class="btn btn-warning"><i
                                        class="fa-solid fa-pen-to-square"></i></a>
                                <form action="/review-literasi/{{ $r->id }}" method="POST" class="d-inline">
                                    @csrf
                                    @method('DELETE')
