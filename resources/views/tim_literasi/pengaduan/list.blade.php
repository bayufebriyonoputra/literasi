...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Modul &nbsp;</span>Pengaduan</h4>
            ...
            <table class="table" id="table">
                ...
                <tbody>
                    @foreach ($pengaduan as $p)
                        <tr>
                            <td>{{ Carbon\Carbon::parse($p->tanggal)->locale('id_ID')->isoFormat('DD MMMM YYYY') }}</td>
                            <td>{{ $p->email }} </td>
                            <td>{{ $p->pengaduan }}</td>
