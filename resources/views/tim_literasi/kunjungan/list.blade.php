...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <p class="text-primary fs-5">Catatan : kriteria ketercapaian kunjungan kerohanian adalah jika murid telah melakukan 3
            kali kegiatan kujungan</p>
        <p>Pilih Kelas</p>
        <form method="POST" action="/filter-kunjungan" class="mb-4">
            @csrf
            <div class="row">
                <div class="col-md-10">
                ...
                <tbody>
                    @foreach ($kunjungan as $k)
                        <tr>
                            ...
                            <td><a href="/inovasi-detail-kunjungan/{{ $k[0]->siswa_id }}" class="btn btn-warning">Detail</a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
