...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4">
            <span class="text-muted fw-light">Modul</span> Update Buku
        </h4>
        ...
        <div class="row">
            ...
            <div class="col-xxl">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form action="/perpustakaan/{{ $buku->id }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" min="1900" max="2099" step="1" class="form-control"
                                        id="basic-default-name" name="tahun_terbit" value="{{ $buku->tahun_terbit }}" />
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea rows="3" class="form-control" name="sinopsis">{{ $buku->sinopsis }}</textarea>
                                </div>
                            </div>
                            <div class="row mb-3">
