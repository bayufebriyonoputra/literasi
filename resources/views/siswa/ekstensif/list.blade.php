                ...
                <tbody>
                    @foreach ($ekstensif as $e)
                        <tr>
                            ...
                            <td>{{ $e->isbn }}</td>
                            <td>{{ $e->judul_buku }}</td>
                            <td>{{ $e->jumlah_halaman }}</td>
                            <td class="text-wrap width-200">{{ $e->rangkuman }}</td>
                            <td>
                                <a href="/ekstensif/{{ $e->id }}/edit" class="btn btn-warning"><i
                                        class="fa-solid fa-pen-to-square"></i></a>

                                <form action="/ekstensif/{{ $e->id }}" class="d-inline" method="POST">
                                    @csrf
                                    @method('DELETE')
