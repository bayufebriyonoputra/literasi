        ...
        <div class="row">
            ...
            <div class="col-xxl">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form action="/kerohanian/{{ $kerohanian->id }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="date" class="form-control" id="basic-default-name" name="tanggal"
                                        value="{{ \Carbon\Carbon::parse($kerohanian->tanggal)->format('Y-m-d') }}"
                                        required />
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" class="form-control" id="basic-default-name" name="durasi"
                                        value="{{ $kerohanian->durasi }}" required />
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="laporan_kegiatan" id="" rows="3" class="form-control">{{ $kerohanian->laporan_kegiatan }}</textarea>
                                </div>
                            </div>
