...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Modul &nbsp;</span>Laporan UKBI</h4>
                ...
                <tbody>
                    @foreach ($ukbi as $u)
                        <tr>
                            ...
                            <td><a href="{{ asset('uploads/' . $u->sertifikat) }}" class="btn btn-info">Lihat Sertifikat</a>
                            </td>
                            <td>
                                <a href="/ukbi/{{ $u->id }}/edit" class="btn btn-warning"><i
                                        class="fa-solid fa-pen-to-square"></i></a>

                                <form action="/ukbi/{{ $u->id }}" class="d-inline" method="POST">
                                    @csrf
                                    @method('DELETE')
