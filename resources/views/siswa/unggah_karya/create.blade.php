...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4">
            <span class="text-muted fw-light">Modul</span> Unggah Karya
        </h4>
        ...
        <div class="row">
            ...
            <div class="col-xxl">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form action="/unggah_karya" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <select name="karya_id" id="" class="form-select">
                                        @foreach ($karya as $k)
                                            <option value="{{ $k->id }}">{{ $k->karya }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
