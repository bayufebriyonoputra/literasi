...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Daftar &nbsp;</span>Kegiatan Perpustakaan</h4>
            ...
            <table class="table" id="table">
                <thead>
                    <tr>
                        ...
                        <th>Tanggal</th>
                        <th>Nama Kegiatan</th>
                        <th class="text-wrap width-200">Deskripsi</th>
                        <th>Foto Kegiatan</th>
                        <th>Aksi</th>
                    </tr>
                </thead>
                <tbody>
                    @foreach ($kegiatan as $k)
                        <tr>
                            ...
                            <td>
                                <a href="/tim-perpustakaan/{{ $k->id }}" class="btn btn-warning"><i
                                        class="fa-solid fa-pen-to-square"></i></a>
                                <form action="/tim-perpustakaan/{{ $k->id }}" class="d-inline" method="POST">
                                    @csrf
                                    @method('DELETE')
