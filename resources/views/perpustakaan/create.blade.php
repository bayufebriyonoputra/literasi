    ...
    <div class="container">
        <div class="col-xxl">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form action="/tim-perpustakaan/add" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <textarea id="basic-default-message" class="form-control @error('deskripsi') is-invalid @enderror"
                                    placeholder="Ex : Deskripsi Kegiatan..." name="deskripsi" required>{{ old('deskripsi') }}</textarea>
                                @error('deskripsi')
                                    <p class="text-danger">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                ...
                                <p class="text-muted">Jenis file adalah foto (*png, *jpg, *jpeg)</p>
                                @error('foto')
                                    <p class="text-danger">{{ $message }}</p>
                                @enderror
                            </div>
