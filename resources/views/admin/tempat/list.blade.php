...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Data &nbsp;</span>Tempat</h4>
                ...
                <tbody>
                    @foreach ($tempat as $t)
                        <tr>
                            ...
                            <td>{{ $t->tempat }}</td>
                            <td>
                                <a href="/tempat/{{ $t->id }}/edit" class="btn btn-warning"><i
                                        class="fa-solid fa-pen-to-square"></i></a>
                                <form action="/tempat/{{ $t->id }}" class="d-inline" method="POST">
                                    @csrf
                                    @method('DELETE')
