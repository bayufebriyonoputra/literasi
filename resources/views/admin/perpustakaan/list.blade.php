                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="modalCenterTitle">Tambahkan Tim Perpustakaan</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <form action="/admin-perpustakaan" method="POST">
                            @csrf
            ...
            <tbody>
                @foreach ($perpus as $l)
                    <tr>
                        ...
                        <td>{{ $l->nama }}</td>
                        <td>
                            <form action="/admin-perpustakaan/{{ $l->id }}" class="d-inline" method="POST">
                                @csrf
                                @method('DELETE')
